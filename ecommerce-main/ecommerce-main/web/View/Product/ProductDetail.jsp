...
<html>
    <head>
        ...
        <style>
            <%@ include file="ProductDetailCSS.css" %>
        </style>
    </head>
    <body>
                    ...
                    <main class="col-lg-8 bg-white p-4"> <!-- Chỉnh lại từ col-lg-6 thành col-lg-8 để chiếm 2/3 -->
                        <div class="ps-lg-3">
                            ...
                            <div class="mt-4 d-flex gap-3">
                                ...
                                <a href="" id="addToCartBtn" class="btn btn-outline-danger px-5 py-3 fw-bold rounded border-2">
                                    Add to Cart
                                </a>
                            </div>
                            <script>
                                $(document).ready(function () {
                                    $("#addToCartBtn").click(function (event) {
                                        ...
                                        $.post("${pageContext.request.contextPath}/addProductToCart", {
                                            ...
                                            alert("⚠️ Error! Please login before adding products...");
                                        });
                                    });
                                });
